...
const ChatRoom = ({ roomId, currentUser }) => {
  const [messages, setMessages] = useState([
    ...
    {
      profileImg:"https://play-lh.googleusercontent.com/Kbu0747Cx3rpzHcSbtM1zDriGFG74zVbtkPmVnOKpmLCS59l7IuKD5M3MKbaq_nEaZM=w240-h480-rw",
      id: 2,
      chatRoomId: 4,
      name: "이해진",
      title: "대표",
